...
const Skills = () => {
  ...
  return (
    <div id='Skills' className='w-screen flex items-center justify-center min-h-[calc(100vh-44px)] md:min-h-screen lg:min-h-screen md:mt-0 lg:mt-0 py-28 px-4 md:p-6 lg:p-10 '>
      ...
      <div className="h-full w-full max-w-7xl text-slate-400 flex flex-col items-center mt-8 justify-center gap-44 md:gap-12 p-4 md:p-6 lg:p-10">
        ...
        <div className="w-full flex flex-col justify-center items-center gap-8 mt-16 md:mt-0 lg:mt-0">
          ...
          <ul className="w-full grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
