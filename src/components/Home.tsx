...
const Home = () => {
    ...
    return (
        ...
        <section
            ...
            id='Home'
            className="flex min-h-[calc(100vh-44px)] md:min-h-screen lg:min-h-screen w-full items-center justify-center bg-cover bg-center bg-[url('/images/bgAuroraLight.jpg')] dark:bg-[url('/images/bgAuroraBlack.jpg')]"
        >

            <div className="flex max-w-[350px] md:max-w-4xl flex-col items-center md:flex-row justify-center gap-8 p-5 text-center z-10">

                <motion.img
                    src="/images/InShot_20250702_225115347.png"
                    alt="Imagem de perfil"
                    className='w-[180px] h-[180px] sm:w-[240px] sm:h-[240px] md:w-[300px] md:h-[300px] object-cover rounded-full bg-gradient-to-r from-black to-stone-800 shadow-2xl shadow-stone-700 dark:shadow-stone-950'
                ...
                <nav className="flex lg:hidden fixed bottom-0 left-0 right-0 h-11 justify-center items-center border-t bg-zinc-200 dark:bg-black z-40">
                    <Menu />
                </nav>
