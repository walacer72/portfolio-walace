    ...
    return (
        <div id='About' className="min-h-screen w-screen flex justify-center items-center">
            <div className="flex flex-col gap-4 md:gap-8 justify-center items-center w-full max-w-6xl p-4 md:p-8 mx-4">
                <h1 className="bg-gradient-to-r from-sky-800 to-sky-200 bg-clip-text text-4xl font-semibold text-transparent">Sobre mim</h1>
                <div className="flex flex-col md:gap-8 p-4 md:p-8 bg-[rgba(0,0,0,0.5)] rounded-3xl">
                    <p className="text-sm text-slate-400 md:leading-relaxed">Sou um profissional em transição de carreira para a área de tecnologia, atualmente cursando Análise e Desenvolvimento de Sistemas. Apesar de ainda não ter experiência formal na área de desenvolvimento, venho me preparando intensamente através de cursos práticos com foco em desenvolvimento web.
                    ...
                    <p className="text-sm text-slate-400 md:leading-relaxed">Hoje, busco uma oportunidade para aplicar minhas habilidades técnicas em projetos reais e contribuir com times de tecnologia, unindo minha experiência de gestão com a paixão por Ti.</p>
                    ...
                    <div className="flex justify-between mt-4">
                        <div className="flex gap-2 md:gap-4 lg:gap-4 items-center ">
                            <div className="flex flex-col">
                                ...
                                <p className="text-sm text-slate-400 opacity-50">Projetos pessoais</p>
                            </div>
                            <div className="flex flex-col">
                                <div className="flex items-center">
                                ...
                                <p className="text-sm text-slate-400 opacity-50">Projetos acadêmicos</p>
                            </div>
                        </div>
