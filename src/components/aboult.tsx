...
export const Aboult = () => {
    ...
    return (
        <div id='Aboult' className="min-h-screen w-screen flex justify-center items-center">
            <div className="flex flex-col gap-4 md:gap-8 justify-center items-center w-full max-w-6xl p-2 md:p-8 mx-4">
                <h1 className="bg-gradient-to-r from-sky-800 to-sky-200 bg-clip-text text-4xl font-semibold text-transparent">Aboult</h1>
                <div className="flex flex-col md:gap-8 p-8 bg-[rgba(0,0,0,0.5)] rounded-3xl">
                    ...
                    <div className="flex justify-between mt-4">
                        ...
                        <button className="bg-sky-700 rounded-full transition-all ease-in px-6 hover:-translate-y-2">Curriculo</button>
                    </div>
                </div>
            </div>
        </div>
