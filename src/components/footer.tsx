export const Footer = () => {
    return (
        <div className="w-full mx-auto max-w-6xl flex flex-col gap-2 justify-center items-center md:flex-row md:justify-between border-t border-primary-foreground/40 text-primary-foreground/90 p-6 text-sm">
